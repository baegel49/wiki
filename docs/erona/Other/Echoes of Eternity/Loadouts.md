...
| D5  | Loadout                                                             |
| --- | ------------------------------------------------------------------- |
| 1   | Boarding Axe, Leather Armour (AP 4), Rope, Harmonica, 5 Rations     |
| 2   | One-handed sword, Chainmail (AP 7), Wooden Shield (AP 5), 5 Torches |
| 3   | Glaive, Dagger, Scale Armour (AP 8), War Horn                       |
| 4   | Two-handed Sword, Crossbow, 12 Bolts, Gambeson (AP 5)               |
| 5   | Noble Sword, Finery (AP 2), Cloak, Flask of Wine, Signet Ring       |
...
| D5  | Loadout                                                                      |
| --- | ---------------------------------------------------------------------------- |
| 1   | Golden Robes (AP 3), Sun Staff (Bolt of Light), 5 Candles                    |
| 2   | Segmented Plate (AP 10), One-Handed Sword, Steel Shield (AP 9), Seal of Oath |
| 3   | Clerical Robes (AP 3), Book of Scripture, Idol of the Watcher (Compel)       |
| 4   | Wolfskin (AP 4), Wooden Staff (Thorns), 5 Torches                            |
| 5   | Occultist Robes (AP 2), Forbidden Idol (Hex), 3 Elixir                       |
